      ...
      <footer className="p-4 bg-slate-900 border-t border-slate-800">
        <form onSubmit={handleSubmit} className="relative max-w-4xl mx-auto">
          <textarea
            ...
            className="w-full bg-slate-800 text-slate-100 placeholder-slate-500 rounded-xl py-4 pl-5 pr-14 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 border border-slate-700 transition-all resize-none min-h-14 max-h-50 overflow-y-auto"
            disabled={isLoading}
            rows={2}
          />
          <button
